...
function cyberoccultism(){
 ...
 if (gillup == false){
  gillup = true;
  document.getElementById("gill").src = "images/gill-stance.gif";
  if (bgmon){
  sfx.play();
  setTimeout(function() {
  document.getElementById("gill").src = "images/gill-stance.gif";
...
for (let i = 0; i < document.images.length; i++){
  if (document.images[i].src != "https://cyberoccultism.online.org/images/gill.gif" && document.images[i].src != "https://cyberoccultism.online/images/gill2.gif" && document.images[i].src != "https://cyberoccultism.online/images/gill-stance.gif" && document.images[i].src != "https://cyberoccultism.online/images/gillp.gif" && document.images[i].src != "https://cyberoccultism.online/images/gill2p.gif" && document.images[i].src != "https://cyberoccultism.online/images/gill-stancep.gif"){
